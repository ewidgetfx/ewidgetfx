 ...
 */
package org.carlfx.widget.googleweather;
 ...
 * @since 1.0
 */
public class GoogleWeatherWidget extends DefaultWidget {
    ...
    public static void main(String[] args) {
        ...
        GoogleWeatherWidget widget = new GoogleWeatherWidget();
        widget.setDecoration(DECORATION.STAGED_CLOSE);
